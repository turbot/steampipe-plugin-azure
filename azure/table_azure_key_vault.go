...
func tableAzureKeyVault(_ context.Context) *plugin.Table {
	return &plugin.Table{
		...
		HydrateConfig: []plugin.HydrateConfig{
			...
			{
				Func: listKeyVaultDefaultBlobDiagnosticSettings,
				Tags: map[string]string{
					"service": "Microsoft.Insights",
					"action":  "diagnosticSettings/read",
				},
			...
			{
				Func: listKeyVaultDefaultFileDiagnosticSettings,
				Tags: map[string]string{
					"service": "Microsoft.Insights",
					"action":  "diagnosticSettings/read",
				},
			...
			{
				Func: listKeyVaultDefaultTableDiagnosticSettings,
				Tags: map[string]string{
					"service": "Microsoft.Insights",
					"action":  "diagnosticSettings/read",
				},
			...
			{
				Func: listKeyVaultDefaultQueueDiagnosticSettings,
				Tags: map[string]string{
					"service": "Microsoft.Insights",
					"action":  "diagnosticSettings/read",
				},
		...
		Columns: azureColumns([]*plugin.Column{
			...
			},
			{
				...
				Description: "A list of default diagnostic settings for the vault blob service.",
				Type:        proto.ColumnType_JSON,
				Hydrate:     listKeyVaultDefaultBlobDiagnosticSettings,
				Transform:   transform.FromValue(),
			},
			{
				Name:        "default_file_diagnostic_settings",
				Description: "A list of default diagnostic settings for the vault file service.",
				Type:        proto.ColumnType_JSON,
				Hydrate:     listKeyVaultDefaultFileDiagnosticSettings,
				Transform:   transform.FromValue(),
			},
			{
				Name:        "default_table_diagnostic_settings",
				Description: "A list of default diagnostic settings for the vault table service.",
				Type:        proto.ColumnType_JSON,
				Hydrate:     listKeyVaultDefaultTableDiagnosticSettings,
				Transform:   transform.FromValue(),
			},
			{
				Name:        "default_queue_diagnostic_settings",
				Description: "A list of default diagnostic settings for the vault queue service.",
				Type:        proto.ColumnType_JSON,
				Hydrate:     listKeyVaultDefaultQueueDiagnosticSettings,
				Transform:   transform.FromValue(),
			},
			{
				Name:        "network_acls",
...
func listKeyVaultDefaultBlobDiagnosticSettings(ctx context.Context, d *plugin.QueryData, h *plugin.HydrateData) (interface{}, error) {
	plugin.Logger(ctx).Trace("listKeyVaultDefaultBlobDiagnosticSettings")
	id := getKeyVaultID(h.Item) + "/blobServices/default"
...
func listKeyVaultDefaultFileDiagnosticSettings(ctx context.Context, d *plugin.QueryData, h *plugin.HydrateData) (interface{}, error) {
	plugin.Logger(ctx).Trace("listKeyVaultDefaultFileDiagnosticSettings")
	id := getKeyVaultID(h.Item) + "/fileServices/default"
...
func listKeyVaultDefaultTableDiagnosticSettings(ctx context.Context, d *plugin.QueryData, h *plugin.HydrateData) (interface{}, error) {
	plugin.Logger(ctx).Trace("listKeyVaultDefaultTableDiagnosticSettings")
	id := getKeyVaultID(h.Item) + "/tableServices/default"
...
func listKeyVaultDefaultQueueDiagnosticSettings(ctx context.Context, d *plugin.QueryData, h *plugin.HydrateData) (interface{}, error) {
	plugin.Logger(ctx).Trace("listKeyVaultDefaultQueueDiagnosticSettings")
	id := getKeyVaultID(h.Item) + "/queueServices/default"
