...
func tableAzureAppServiceEnvironment(_ context.Context) *plugin.Table {
	return &plugin.Table{
		...
		Columns: []*plugin.Column{
			...
			{
				Name:        "resource_group",
				Description: "The name of the resource group in which the app service environment is created",
				Type:        proto.ColumnType_STRING,
				Transform:   transform.FromField("AppServiceEnvironment.ResourceGroup"),
			},
			{
