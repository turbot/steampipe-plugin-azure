	...
	return &plugin.Table{
		...
		Get: &plugin.GetConfig{
			...
			Tags: map[string]string{
				...
				"action":  "loadBalancers/loadBalancingRules/read",
			},
...
func listLoadBalancerRules(ctx context.Context, d *plugin.QueryData, h *plugin.HydrateData) (interface{}, error) {
	...
	// Apply Retry rule
	ApplyRetryRules(ctx, &listLoadBalancerRulesClient, d.Connection)
...
func getLoadBalancerRule(ctx context.Context, d *plugin.QueryData, h *plugin.HydrateData) (interface{}, error) {
	...
	// Apply Retry rule
	ApplyRetryRules(ctx, &loadBalancerRuleClient, d.Connection)
