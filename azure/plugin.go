...
func Plugin(ctx context.Context) *plugin.Plugin {
	p := &plugin.Plugin{
		...
		TableMap: map[string]*plugin.Table{
			...
			"azure_compute_virtual_machine_metric_memory_available_utilization":        tableAzureComputeVirtualMachineMetricMemoryAvailableUtilization(ctx),
			"azure_compute_virtual_machine_metric_memory_available_utilization_daily":  tableAzureComputeVirtualMachineMetricMemoryAvailableUtilizationDaily(ctx),
			"azure_compute_virtual_machine_metric_memory_available_utilization_hourly": tableAzureComputeVirtualMachineMetricMemoryAvailableUtilizationHourly(ctx),
