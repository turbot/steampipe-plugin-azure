...
func Plugin(ctx context.Context) *plugin.Plugin {
	p := &plugin.Plugin{
		...
		TableMap: map[string]*plugin.Table{
			...
			"azure_compute_disk_metric_read_ops":                          tableAzureComputeDisksMetricReadOps(ctx),
			"azure_compute_disk_metric_read_ops_hourly":                   tableAzureComputeDisksMetricReadOpsHourly(ctx),
			"azure_compute_disk_metric_read_ops_daily":                    tableAzureComputeDisksMetricReadOpsDaily(ctx),
			"azure_compute_disk_metric_write_ops":                         tableAzureComputeDisksMetricWriteOps(ctx),
			"azure_compute_disk_metric_write_ops_daily":                   tableAzureComputeDisksMetricWriteOpsDaily(ctx),
			"azure_compute_disk_metric_write_ops_hourly":                  tableAzureComputeDisksMetricWriteOpsHourly(ctx),
			...
			"azure_compute_virtual_machine_metric_cpu_utilization":        tableAzureComputeInstanceMetricCpuUtilization(ctx),
			"azure_compute_virtual_machine_metric_cpu_utilization_daily":  tableAzureComputeInstanceMetricCpuUtilizationDaily(ctx),
			"azure_compute_virtual_machine_metric_cpu_utilization_hourly": tableAzureComputeInstanceMetricCpuUtilizationHourly(ctx),
