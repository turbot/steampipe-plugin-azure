...
func Plugin(ctx context.Context) *plugin.Plugin {
	p := &plugin.Plugin{
		...
		TableMap: map[string]*plugin.Table{
			...
			"azure_compute_disk_metric_read_ops":                          tableAzureComputeDisksReadOpsMetric(ctx),
			"azure_compute_disk_metric_read_ops_hourly":                   tableAzureComputeDisksReadOpsMetricHourly(ctx),
			"azure_compute_disk_metric_read_ops_daily":                    tableAzureComputeDisksReadOpsMetricDaily(ctx),
			"azure_compute_disk_metric_write_ops":                         tableAzureComputeDisksWriteOpsMetric(ctx),
			"azure_compute_disk_metric_write_ops_daily":                   tableAzureComputeDisksWriteOpsMetricDaily(ctx),
			"azure_compute_disk_metric_write_ops_hourly":                  tableAzureComputeDisksWriteOpsMetricHourly(ctx),
			...
			"azure_compute_virtual_machine_metric_cpu_utilization":        tableAzureComputeInstanceCpuUtilizationMetric(ctx),
			"azure_compute_virtual_machine_metric_cpu_utilization_daily":  tableAzureComputeInstanceCpuUtilizationMetricDaily(ctx),
			"azure_compute_virtual_machine_metric_cpu_utilization_hourly": tableAzureComputeInstanceCpuUtilizationMetricHourly(ctx),
