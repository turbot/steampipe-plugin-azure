	...
	return &plugin.Table{
		...
		Columns: []*plugin.Column{
			...
			},
			{
				...
				Description: "The provisioning state of the vault.",
				Type:        proto.ColumnType_STRING,
				Transform:   transform.FromField("Properties.ProvisioningState"),
			},
			{
				Name:        "sku_name",
				Description: "The sku name of the vault.",
				Type:        proto.ColumnType_STRING,
			...
			{
				Name:        "identity",
				Description: "Managed service identity of the vault.",
				Type:        proto.ColumnType_JSON,
			},
			{
			...
			},
			{
				...
				Description: "Upgrade details properties of the vault.",
				Type:        proto.ColumnType_JSON,
