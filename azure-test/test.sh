...
run_test azure_automation_account
run_test azure_automation_variable
run_test azure_backup_policy
...
run_test azure_firewall_policy
...
run_test azure_key_vault_key_version
...
run_test azure_maintenance_configuration
run_test azure_management_lock
run_test azure_mariadb_server
run_test azure_monitor_log_profile
...
run_test azure_private_dns_zone
