...
output "resource_aka" {
  value = "azure://${azurerm_function_app.named_test_resource.id}"
}

output "resource_aka_lower" {
  value = "azure://${lower(azurerm_function_app.named_test_resource.id)}"
}
...
output "resource_id" {
  value = azurerm_function_app.named_test_resource.id
}
